<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="demoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column v-if="false" label="主键" align="center" prop="nodeId" />
      <el-table-column label="菜单名" align="center" prop="nodeName" />
      <!-- <el-table-column label="用户id" align="center" prop="userId" /> -->
      <el-table-column label="排序号" align="center" prop="nodeCode" />
