  ...
  <div class="resume">
    ...
    <div class="content">
      <div class="content__left">
        ...
        <div class="section">
          ...
          <div class="section-content section-content--plain">
            ...
            >
              <i class="section-link__icon fa fa-globe" />{{ person.contact.website }}
            </a>
            ...
            >
              <i class="section-link__icon fa fa-linkedin" />{{ person.contact.linkedin }}
            </a>
            ...
            >
              <i class="section-link__icon fa fa-github" />{{ person.contact.github }}
            </a>
            ...
            >
              <i class="section-link__icon fa fa-medium" />{{ person.contact.medium }}
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="content__right">
        ...
        >
          <div class="section-headline">
            <i class="section-headline__icon fa fa-heart" />{{ lang.contributions }}
          </div>
