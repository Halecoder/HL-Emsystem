  ...
  <div id="resume2" class="resume">
    <div class="left-column">
      ...
      <div class="social-container">
        ...
        >
          ...
          <div class="block-marged txt-full-white">
            <i class="fa fa-globe contact-icon" />
        ...
        >
          ...
          <i class="fa fa-github contact-icon" />
        ...
        <a
          ...
          class="external-link"
        >
          <i class="fab fa-medium contact-icon" />
          <span class="block-marged txt-full-white">
      ...
      <div class="hobbies-container">
        ...
        <div class="hobbies-content">
          ...
          >
            ...
            <i v-if="hobby.iconClass" :class="hobby.iconClass + ' hobby-item__icon'" />
    ...
    <div class="right-column">
      ...
      >
        ...
        <div class="icon">
          <i class="fa fa-heart font-awesome-icons" />
