      ...
      <div id="header-left">
        ...
        <div id="info-flex">
          <span id="email"><a :href="&quot;mailto:&quot; + person.contact.email">
            <i class="fa fa-envelope" aria-hidden="true" /> {{ person.contact.email }}</a></span>
          <span id="phone"><i class="fa fa-phone-square" aria-hidden="true" /> {{ person.contact.phone }}</span>
          <span v-if="person.contact.website" id="website"><a :href="person.contact.website"><i class="fa fa-home" aria-hidden="true" /> {{ person.contact.website }}</a></span>
          <span v-if="person.contact.github" id="github"><a :href="contactLinks.github"><i class="fa fa-github" aria-hidden="true" /> {{ person.contact.github }}</a></span>
        </div>
      </div>
      <div id="header-right">
        <div id="headshot" />
