<template>
  <div class="resume">
    ...
    <div class="rightCol">
      ...
      <div v-for="experience in person.experience" class="block">
      ...
      <div v-for="education in person.education" class="block">
        <div class="block-helper" />
    ...
    <div class="farRightCol">
      ...
      <div v-for="project in person.projects" class="block">
        <div class="block-helper" />
